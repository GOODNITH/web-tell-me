...
{#if currentTab === 'calendario'}
  <div class="content">
    ...
    <div class="calendar">
      <a href="1" class="day today" on:click={() => verCita('Ana García', '24/10/2023', '10:00')}>
        24<br>Ana García<br><span class="badge">10:00</span>
      </a>
      
      <a href="1" class="day" on:click={() => verCita('Carlos Rodríguez', '25/10/2023', '14:00')}>
